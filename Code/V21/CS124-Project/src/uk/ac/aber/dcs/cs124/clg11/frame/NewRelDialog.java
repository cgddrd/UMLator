		...
		OK.addActionListener(new ActionListener()
		{
			...
			public void actionPerformed(ActionEvent event)
			{
				...
				if ("".equals(assVar.getText())){
					...
					RelationshipDiag rel = new RelationshipDiag(classObject1, classObject2, "private Arraylist<" + displayClass2.getText() + "> " + assVar.getText(),classANum, classBNum, RelType);
