...
public class ButtonPanel extends JPanel {
	...
	public ButtonPanel(CanvasPanel cP) {
		...
		//Create image label to display program logo in panel
		BufferedImage myPicture = null;
		String curDir = System.getProperty("user.dir");
		
		try {
			myPicture = ImageIO.read(new File(curDir + directEnd + "logo.png"));
		} catch (IOException e) {
			JOptionPane.showMessageDialog(null, "Icon image not found - Cannot display - " + e,"UMLator | Error", JOptionPane.ERROR_MESSAGE);
		}
