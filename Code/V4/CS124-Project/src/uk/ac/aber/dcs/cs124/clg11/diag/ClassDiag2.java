...
public class ClassDiag2 {
	...
	private ClassDiagData2 classData;
	private String[] test;
	
	
	public ClassDiag2 (double x, double y, String className, int varNo, int opNo, String variableInput) {
