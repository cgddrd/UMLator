...
public class NewRelDialog implements ActionListener{
	...
	public NewRelDialog(CanvasPanel cp, int x1, int y1, int x2, int y2)
	{
		...
		JLabel displayClass1 = new JLabel(this.class1); // ************************GET CLASS NAME HERE FOR DISPLAY!!!!!!!**********************
		...
		OK.addActionListener(new ActionListener()
		{
			...
			public void actionPerformed(ActionEvent event)
			{
				...
				if ("".equals(assVar.getText())){
					...
					RelationshipDiag rel = new RelationshipDiag(classObject1, classObject2, "private Arraylist<" + displayClass2.getText() + "> " + assVar.getText());
