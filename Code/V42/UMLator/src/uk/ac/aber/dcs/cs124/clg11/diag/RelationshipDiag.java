		...
		if (Math.abs(acx-bcx) > Math.abs(acy-bcy)) { // Check if first class is above second class
			if (bcy < y1) {
				...
				if(x2 > x1) { //Side 1
					...
					g.drawString(reld.getAssocVar(), acx + 50, y1 - 35); //Draw associated variable
					...
					g.drawString(reld.getAssocVar(), acx + 50, y1 - 35);
				}
				...
				if(x2 > x1) { //Side 3
					...
					g.drawString(reld.getAssocVar(), x1 + 230, bcy + 35); 
					...
					g.drawString(reld.getAssocVar(), x1 - 80, bcy + 55); 
				...
				if(x2 > x1) { //Side 5
					...
					g.drawString(reld.getAssocVar(), acx + 60, y1 + 160); 
			...
			if (bcx < x1) {
				...
				if(y2 > y1) { //Side 7
					...
					g.drawString(reld.getAssocVar(), acx - 180, y1 + 100); 
					...
					g.drawString(reld.getAssocVar(), x1 - 70, y1 + 70); 
				}
				...
				if(y2 > y1) { //Side 9
					...
					g.drawString(reld.getAssocVar(), x2 + 150, y1 + 170); 
					...
					g.drawString(reld.getAssocVar(), x2 + 130, y1 - 30); 
				}
				...
				if(y2 > y1) { //Side 11
					...
					g.drawString(reld.getAssocVar(), acx + 150, y1 + 70); 
					...
					g.drawString(reld.getAssocVar(), acx + 140, y1 + 100); 
				}
			}
		}
