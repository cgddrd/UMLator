...
public class NewRelDialog implements ActionListener{
	...
	public void addRel(int x1, int y1, int x2, int y2) {
		...
		ClassData d = (ClassData) class1.getData(); //How to obtain data from a class that you want...
		this.class1 = d.getClassName();
		
		d = (ClassData) class2.getData(); //How to obtain data from a class that you want...
