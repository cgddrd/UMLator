...
final String[] objectinit = { "Public", "Private", "Protected", "Defualt"};
final String[] typeinit = { "Int", "String", "Bool" "Double", "Void", "Other"};
JComboBox objectsA = new JComboBox(objectinit);
JComboBox objectsB = new JComboBox(typeinit);
JComboBox methodsA = new JComboBox(typeinit);
JComboBox methodsB = new JComboBox(typeinit);
...
textt = new JTextField();
        textt.disable();
        objectsA.addActionListener(new ActionListener()
        {
            ...
            public void actionPerformed(ActionEvent event)
            {
                ...
                if (objectsB.getSelectedItem() = "Other") {textt.enable();}
