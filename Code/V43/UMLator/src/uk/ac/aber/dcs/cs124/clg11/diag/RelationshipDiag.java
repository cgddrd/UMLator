...
public class RelationshipDiag extends Drawable {
	...
	public void paint(Graphics g) {
		...
		if (Math.abs(acx-bcx) > Math.abs(acy-bcy)) { // Check if first class is above second class
			if (bcy < y1) {
				...
				if(x2 > x1) { //Side 1
					...
					if (reld.getRelType().equals("ASSOCIATION")) { //Check the relationship type
					...
					g.drawString(reld.getAssocVar(), acx + 10, y1 - 50); //Draw associated variable
					...
					g.drawString(reld.getClassBMulti(), x2 + reld.getClassB().getWidth() + 20, bcy + 20); 
					g.drawString(reld.getClassAMulti(), acx + 10, y1 - 15);
					g.drawString(reld.getAssocVar(), acx + 10, y1 - 55);
				}
				...
				if(x2 > x1) { //Side 3
					...
					g.drawString(reld.getClassAMulti(), x1 + reld.getClassA().getWidth() + 10, bcy + 15);
					g.drawString(reld.getAssocVar(), x1 + reld.getClassA().getWidth() + 10, bcy + 35); 
					...
					g.drawString(reld.getClassBMulti(), x2 + reld.getClassB().getWidth() + 30, bcy + 20);
					g.drawString(reld.getClassAMulti(), x1 - 30, bcy + 20);
					g.drawString(reld.getAssocVar(), x1 - 200, bcy - 20); 
				...
				if(x2 > x1) { //Side 5
					...
					g.drawString(reld.getClassBMulti(), x2 - 40, bcy + 15); 
					g.drawString(reld.getClassAMulti(), acx + 10, y1 + reld.getClassA().getHeight() + 20);
					g.drawString(reld.getAssocVar(), acx + 10, y1 + reld.getClassA().getHeight() + 60); 
			...
			if (bcx < x1) {
				...
				if(y2 > y1) { //Side 7
					...
					g.drawString(reld.getClassBMulti(), bcx + 10, y2 - 30); 
					g.drawString(reld.getClassAMulti(), x1 - 20, acy + 20);
					g.drawString(reld.getAssocVar(), x1 - 30 , y1 + reld.getClassA().getHeight() + 20); 
					...
					g.drawString(reld.getClassBMulti(), bcx + 10, y2 + reld.getClassB().getHeight() + 30); 
					g.drawString(reld.getClassAMulti(), x1 - 30, acy - 10);
					g.drawString(reld.getAssocVar(), bcx + 10, y2 + reld.getClassB().getHeight() + 80); 
				}
				...
				if(y2 > y1) { //Side 9
					...
					g.drawString(reld.getClassAMulti(), bcx + 10, y1 + reld.getClassA().getHeight() + 20);
					g.drawString(reld.getAssocVar(), bcx + 10, y1 + reld.getClassA().getHeight() + 60); 
					...
					g.drawString(reld.getClassBMulti(), bcx + 10,  y2 + reld.getClassB().getHeight() + 30);
					g.drawString(reld.getClassAMulti(), acx + 10, y1 - 10);
					g.drawString(reld.getAssocVar(), bcx + 10, y2 + reld.getClassB().getHeight() + 80); 
				}
				...
				if(y2 > y1) { //Side 11
					...
					g.drawString(reld.getClassAMulti(), x1 + reld.getClassA().getWidth() + 10, acy - 10);
					g.drawString(reld.getAssocVar(), x1 + reld.getClassA().getWidth() + 30, y1 + 140); 
					...
					g.drawString(reld.getClassBMulti(), bcx + 10, y2 + reld.getClassB().getHeight() + 30); 
					g.drawString(reld.getClassAMulti(), x1 + reld.getClassA().getWidth() + 10, acy - 10);
					g.drawString(reld.getAssocVar(), x1 + reld.getClassA().getWidth() + 50, y1 + 20); 
				}
			}
		}
		...
		if (reld.getRelType().equals("AGGREGATION")) { //Determine relationship type
		...
		} else if (reld.getRelType().equals("ASSOCIATION")) {
		...
		} else if (reld.getRelType().equals("COMPOSITION")) {
		...
		} else if (reld.getRelType().equals("INHERITANCE")) {
