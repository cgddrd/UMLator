		...
		if (Math.abs(acx-bcx) > Math.abs(acy-bcy)) {
			if (bcy < y1) {
				...
				if(x2 > x1) {
					...
					g.drawString(classBMulti, x2 + 190, bcy + 20); //DRAW MULTIPLICITIES
					g.drawString(classAMulti, acx + 10, y1 - 15);
				}
				...
				if(x2 > x1) {
					...
					g.drawString(classBMulti, x2 - 40, bcy + 15); //DRAW MULTIPLICITIES
					g.drawString(classAMulti, x1 + 185, acy + 15);
				} else {
			...
			if (bcx < x1) {
				...
				if(y2 > y1) {
					...
					g.drawString(classBMulti, x2 + 100, bcy + 80); //DRAW MULTIPLICITIES
					g.drawString(classAMulti, acx + 10, y1 - 10);
				}
			} else if (bcx > x1 + w1) {
				...
				if(y2 > y1) {
					...
					g.drawString(classBMulti, x2 + 40, bcy + 55); //DRAW MULTIPLICITIES
					g.drawString(classAMulti, acx + 105, y1 + 70);
				}
			}
		}
